...
function addArtist(array, name, years, genre, nationality, bio) {
  ...
  newArtists.push({name: name, years: years, genre: genre, nationality: nationality, bio: bio });

  return newArtists;
}

console.log("Task 6: ", addArtist(artists, "Franklin", "2001-2022", "Full Stack Development", "Indonesian", "My name is Franklin and I love learning about coding. I also love playing video games."));
